"""Run the model-proposer-to-CORE deductive entailment authority demo.
...
from demos.deductive_entailment_authority.authority import (  # noqa: E402
    TOOL_NAME,
    load_schema,
    run_authority,
)
        ...
        results.append(
            {
                ...
                "oracle_agreement": response["oracle_agreement"],
    ...
    if args.json:
        ...
        for row in results:
            ...
            print(
                ...
                f" oracle_agreement={row['oracle_agreement']})"
            )
