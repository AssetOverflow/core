"""Phase 5.6 domain fluency OOD eval lane runner.
...
en_core_cognition_v1 distribution** — drawn from the cell, organism, ecosystem
public domains and the held-out genetics domain.
