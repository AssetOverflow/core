# Elementary mathematics fluency OOD eval lane (Phase 5.4)

## What it measures

Whether the deterministic realizer produces grammatical English surfaces over elementary-mathematics vocabulary the seed pack does not contain.
...
:  117 cases — 13 constructions × 3 public domains (arithmetic, set, geometry)
